...
def process_trainingcamp(ds_dir, debug, time_shifting, filter_param_list, first_trigger, last_trigger):
	process_dataset(ds_dir, time_shifting=time_shifting, first_trigger=first_trigger, last_trigger=last_trigger, filter_param_list=filter_param_list, debug=debug, override=True, thr=30)
...
if __name__ == "__main__":
	...
	# process_trainingcamp(ds_dir='res/trainingcamp-mne-april',filter_param_list=[(0.02, 0.09, 0.01, 0.1)],  debug=False, time_shifting=time_shifting, first_trigger=9, last_trigger=19)
