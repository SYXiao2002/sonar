...
def process_trainingcamp(dir, debug, filter_param_list):
...
if __name__ == "__main__":
	...
	process_trainingcamp('res/trainingcamp-mne-may',filter_param_list=[(0.007, 0.04, 0.001, 0.03)],  debug=False)
	process_trainingcamp('res/trainingcamp-mne-april',filter_param_list=[(0.02, 0.09, 0.01, 0.1)],  debug=False)
